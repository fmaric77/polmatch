...
exports.ensureCollectionIndexes = ensureCollectionIndexes;
exports.getIndexStats = getIndexStats;
exports.createGroupMessagesPipeline = createGroupMessagesPipeline;
exports.createPrivateConversationsPipeline = createPrivateConversationsPipeline;
 ...
 */
async function ensureIndexes(db, forceRecreate = false) {
 ...
 */
async function ensureCollectionIndexes(db, collectionName) {
 ...
 */
function createGroupMessagesPipeline(groupId, channelId, userId, limit = 50) {
    const pipeline = [
 ...
 */
function createPrivateConversationsPipeline(userId, limit = 50) {
    return [
